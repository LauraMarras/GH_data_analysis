...
if __name__=="__main__":
    for participant in ['01','03']:
        ...
        # Filter data
        for filter in ['nf', 'lowpass', 'theta', 'alpha', 'beta', 'gamma']:
            ...
            for c, channel in enumerate(channels):
                ...
                if True in sign_th[:,c]:
                    directory = (output_path + participant + '/ERP_WvsL/{}/significant/'.format(filter_used))
                else:
                    directory = (output_path + participant + '/ERP_WvsL/{}/not_s/'.format(filter_used))
